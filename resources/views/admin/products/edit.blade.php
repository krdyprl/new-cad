                ...
                <div class="col-md-8">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror" 
                                    ...
                                    <option value="Tradisional" {{ old('category', $product->category) == 'Tradisional' ? 'selected' : '' }}>Tradisional</option>
                                    <option value="Modern" {{ old('category', $product->category) == 'Modern' ? 'selected' : '' }}>Modern</option>
                                    <option value="Dekoratif" {{ old('category', $product->category) == 'Dekoratif' ? 'selected' : '' }}>Dekoratif</option>
                                    <option value="Fungsional" {{ old('category', $product->category) == 'Fungsional' ? 'selected' : '' }}>Fungsional</option>
                                </select>
                                @error('category')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('specifications') is-invalid @enderror" 
                                  ...
                                  placeholder="Contoh:&#10;Material: Tanah liat berkualitas tinggi&#10;Diameter: 25cm&#10;Tinggi: 30cm&#10;Finishing: Glasir alami">{{ old('specifications', $product->specifications) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control @error('ecommerce_link') is-invalid @enderror" 
                               id="ecommerce_link" name="ecommerce_link" value="{{ old('ecommerce_link', $product->ecommerce_link) }}" 
